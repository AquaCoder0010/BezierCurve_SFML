...
g++ *.o -o bin/debug/main.exe -L C:\libs\SFML-2.5.1\lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -lsfml-network
...
g++ *.o -o bin/release/main.exe -L C:\libs\SFML-2.5.1\lib -lsfml-graphics -lsfml-window  -lsfml-system -lsfml-audio -lsfml-network
goto menu
